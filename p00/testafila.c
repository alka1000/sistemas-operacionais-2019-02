...
// de ambas as estruturas sejam os mesmos. De acordo com a seção 6.7.2.1 do
// padrão C99: "Within a structure object, the non-bitfield members and the
// units in which bit-fields reside have addresses that increase in the order
